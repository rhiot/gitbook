...
The body of the message is the current image as a `BufferedInputStream`, while motion events are stored in the header `com.github.sarxos.webcam.WebcamMotionEvent`.
...
**Available for `rhiot.version` >= 0.1.2**
