...
| `trigger`        |    `TRIGGER_NONE` for Producer,   `TRIGGER_RISING_EDGE` or `TRIGGER_FALLING_EDGE` for Consumer      | Trigger of the PIN.  (1) [OR Bitwise](https://en.wikipedia.org/wiki/Bitwise_operation#OR)  |
